    ...
    <div style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: open ? '0 0 14px rgba(236,72,153,0.2)' : 'none',
        }}
        onMouseEnter={(e) => {
      ...
      {open && (
        <div
          style={{
            ...
            boxShadow: '0 16px 40px rgba(0,0,0,0.85), 0 0 20px rgba(236,72,153,0.12)',
            display: 'flex', flexDirection: 'column', gap: '10px',
            zIndex: 9999, backdropFilter: 'blur(14px)',
          }}
        >
          {/* Header */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(236,72,153,0.2)', paddingBottom: '8px' }}>
            <span style={{ fontSize: '8.5px', fontWeight: 800, color: '#ec4899', fontFamily: 'monospace', letterSpacing: '0.8px' }}>
              LAWS-SIM SUPPORT HUB
            </span>
            <span
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
            ...
            <a
              ...
              style={{
                ...
                padding: '8px 12px', borderRadius: '6px', fontSize: '10px', fontWeight: 700,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
            ...
            <button
              ...
              style={{
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '7px',
                padding: '8px 12px', borderRadius: '6px', fontSize: '10px', fontWeight: 700,
                letterSpacing: '0.5px', transition: 'all 0.2s', cursor: 'pointer', outline: 'none', width: '100%',
                background: copied ? 'rgba(34, 197, 94, 0.1)' : 'rgba(168, 85, 247, 0.08)',
                color: copied ? '#22c55e' : '#a855f7',
                border: copied ? '1px solid rgba(34, 197, 94, 0.3)' : '1px solid rgba(168, 85, 247, 0.25)',
              }}
            ...
            <div style={{ display: 'flex', gap: '7px' }}>
              <a
                ...
                style={{
                  ...
                  padding: '8px 4px', borderRadius: '6px', fontSize: '9px', fontWeight: 800,
                  textDecoration: 'none', letterSpacing: '0.3px', transition: 'all 0.2s',
